...
FTD2XX or the free version library libFTDI. A base class called  UsbDeviceDriver implements
...
reading events on all connected DIF. Events can be directly dumped
