...
\begin{frame}{GRPC design}
 ...
 \begin{columns}
      \begin{column}{0.45\textwidth}
        ...
        \begin{center}
          \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{images/GasFlow}};
            \node[align=center,white,font={\big\bfseries}] at (image.center) {Gas flow Studies};
          \end{tikzpicture}
        \end{center}
      \end{column}
\pause
      \begin{column}{0.45\textwidth}
        ...
        \begin{center}
          \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{images/CoatingStudies}};
            \node[align=top,gray,font={\big\bfseries}] at (image.center) {Resistive coating study};
          \end{tikzpicture}
        \end{center}
...
\begin{columns}
      \begin{column}{0.5\textwidth}
        ...
        \begin{center}
          \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{images/ConstructionRPC}} ;
            \node[align=center,yellow,font={\Tiny\rmseries}] at (image.center) {1 m2 Chamber with gas pipe\\and HV connection} ;
          \end{tikzpicture}
        \end{center}
      \end{column}
\pause
      \begin{column}{0.5\textwidth}
        ...
        \begin{center}
          \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{images/1m2HR2}};
            \node[align=center,yellow,font={\Tiny\rmseries}] at (image.center) 
                 {1 m2 electronic,\\ 6 ASUs soldered together,\\ 144 chips,\\ 9216 pads };
          \end{tikzpicture}
        \end{center}
...
\pause
      ...
      \begin{column}{0.5\textwidth}
        ...
        \begin{center}
          \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{images/1m2Cover}} ;
            \node[align=center,yellow,font={\Tiny\rmseries}] at (image.center) {Cassette cover with PCB screwed on it} ;
          \end{tikzpicture}
        \end{center}
      \end{column}
\pause
      \begin{column}{0.5\textwidth}
        ...
        \begin{center}
          \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{images/1m2Cassette}};
            \node[align=center,yellow,font={\Tiny\rmseries}] at (image.center) 
                 {
amagnetic stainless steel walls 2.5 mm thick,\\ Total Thickness = 6mm (active layer)+5 mm (steel) = 11 mm 
} ;
